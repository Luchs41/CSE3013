...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_COMMAND(MENU_SELECT_POINT, &CMainFrame::OnSelectPoint)
	ON_COMMAND(MENU_WATER_FLOW, &CMainFrame::OnWaterFlow)
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	// 도구 모음 및 메뉴 모음을 도킹할 수 없게 하려면 이 다섯 줄을 삭제하십시오.
	...
	// 사용자의 기본 명령을 정의하여 각 풀다운 메뉴에 하나 이상의 기본 명령을 포함시킵니다.
...
void CMainFrame::OnFileOpen()
{
	...
	Invalidate(true);
	if(dlg.DoModal()==IDOK) { 
		data_read((LPCTSTR)dlg.GetPathName());  // F2
		Invalidate(true);
	}
	/* 사용자 입력할거 끝  */
}

void CMainFrame::OnSelectPoint()
{
	// TODO: Add your command handler code here
	/* 사용자 입력할거 시작*/
	change_start_point(); // F7. 시작점 변경 코드.
